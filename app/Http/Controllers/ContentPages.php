...
class ContentPages extends Controller
{
    public function website_settings(Request $request)
    {
        ...
        $output['site_settings']->cta_section = get_page('cta_section');
        $output['site_settings']->services = Service_model::orderBy('id', 'ASC')->where('status', '1')->get();
        $output['site_settings']->aoxs = Job_opportunities_model::orderBy('id', 'ASC')->where('status', '1')->get();
    ...
    public function areas_experties_page(Request $request)
    {
        ...
        $this->data['content_tab1'] = get_page('areas_experties_tab1');
        $this->data['content_tab2'] = get_page('areas_experties_tab2');
        $this->data['cta_section'] = get_page('cta_section');
        $this->data['job_opportunities'] = Job_opportunities_model::orderBy('id', 'ASC')->where('status', '1')->get();
        $this->data['testimonials'] = Testimonial_model::orderBy('id', 'ASC')->where('status', '1')->get();
    ...
    public function hire_talent_page(Request $request)
    {
        $this->data['content'] = get_page('hire_talent');
        $this->data['page_title'] = $this->data['content']['page_title'] . ' - ' . $this->data['site_settings']->site_name;
        $this->data['meta_desc'] = (object)[
            'meta_title' => $this->data['content']['meta_title'],
            'meta_description' => $this->data['content']['meta_description'],
