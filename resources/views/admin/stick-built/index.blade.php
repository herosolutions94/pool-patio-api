...
{!! breadcrumb('Add/Update  Stick Built') !!}
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                <div class="file_choose_icon">
                                    <img src="{{ get_site_image_src('stick', !empty($row) ? $row->image1 : '') }}"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-nowrap mb-0 newTable" id="newTable">
                                            ...
                                            <tbody id="toolRepeater">
                                                @php
                                                $gallery_material = isset($row) ? getGalleryStick($row->id) : [];
                                                $count = 1;
                                                @endphp
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center" id="imgDiv">
                                                            <input type="file" name="gallery_image[]"
                                                                ...
                                                                style="display: none;" />
                                                            <img src="{{ get_site_image_src('stick', !empty($gallery->cover_image) ? $gallery->cover_image : '') }}"
                                                                alt="avatar" class=""
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-nowrap mb-0 newTable" id="newTable">
                                            ...
                                            <tbody id="toolRepeater">
                                                @php
                                                $colours = isset($row) ? getFeaturesStick($row->id) : [];
                                                $count = 1;
                                                @endphp
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-nowrap mb-0 newTable" id="newTable">
                                            ...
                                            <tbody id="toolRepeater">
                                                @php
                                                $product_sizes = isset($row) ? getDesignListStick($row->id) : [];
                                                $count = 1;
                                                @endphp
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center" id="imgDiv">
                                                            <input type="file" name="size_image[]"
                                                                accept="image/*" id="newImgInput"
                                                                style="display: none;" />
                                                            <img src="{{ get_site_image_src('stick', !empty($size->size_image) ? $size->size_image : '') }}"
                                                                alt="avatar" class=""
                                                                style="width: 60%; cursor: pointer;background:#ddd"
                                                                id="newImg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-nowrap mb-0 newTable" id="newTable">
                                            ...
                                            <tbody id="toolRepeater">
                                                @php
                                                $faqs = isset($row) ? getFaqsStick($row->id) : [];
                                                $count = 1;
                                                @endphp
...
@else
{!! breadcrumb('Stick Built ', url('admin/stick-built/add/')) !!}
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-6 crud_thumbnail_icon">
                                    <img src="{{ get_site_image_src('stick', !empty($row->image1) ? $row->image1 : '') }}"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                href="{{ url('admin/stick-built/edit/' . $row->id) }}">
                                                <i class="fs-4 ti ti-edit"></i>Edit
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3"
                                                href="{{ url('admin/stick-built/delete/' . $row->id) }}"
