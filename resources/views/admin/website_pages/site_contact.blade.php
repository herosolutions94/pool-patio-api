                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    <label class="form-label" for="left_heading">Heading</label>
                                    <input class="form-control" id="left_heading" type="text" name="left_heading"
                                        placeholder="" value="{{ $sitecontent['left_heading'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="form_heading" type="text" name="form_heading"
                                        placeholder="" value="{{ $sitecontent['form_heading'] ?? '' }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="left_text">Text</label>
                                    <textarea id="left_text" name="left_text" rows="4" class="editor">{{ $sitecontent['left_text'] ?? '' }}</textarea>
                                </div>
                            </div>
