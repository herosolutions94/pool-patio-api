                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap align-middle dataTable basic-datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>2</td>
                                <td width="65%">Find Jobs</td>
                                <td>
                                    <a href="{{ url('admin/pages/find_jobs') }}" class="btn btn-primary active">Edit
                                        Page</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/pages/services_template') }}"
                            ...
                            <tr>
                                <td>12</td>
                                <td width="65%">How We Work</td>
                                <td>
                                    <a href="{{ url('admin/pages/how_we_work') }}" class="btn btn-primary active">Edit
                                        Page</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/pages/story_and_concept') }}"
                                        class="btn btn-primary active">Edit
                                        Page</a>
                                </td>
                            </tr>
